...
class Bootstrap4_Template extends TemplateBase {
	...
	public function __construct($cache, $smarty, $language, $user, $pages){
		...
		$this->_settings = ROOT_PATH . '/custom/templates/Bootstrap4/template_settings/settings.php';

		$cache->setCache('bs4_template');
		...
		$this->addCSSFiles(array(
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/Bootstrap4/css/' . Output::getClean($theme) . '.min.css' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/css/custom.css' => array(),
			'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css' => array('integrity' => 'sha512-+4zCK9k+qNFUR5X+cKL9EIR+ZOhtIloNl9GIKS57V1MyNsYpYcUrUeQc9vNfzsWfV28IaLL3i96P9sdNyeRssA==', 'crossorigin' => 'anonymous'),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/plugins/toastr/toastr.min.css' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/Bootstrap4/css/custom.css' => array()
		));

		// Add any JS files here
		$this->addJSFiles(array(
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/Bootstrap4/js/jquery.min.js' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/Bootstrap4/js/popper.min.js' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/Bootstrap4/js/bootstrap.min.js' => array(),
	...
	public function onPageLoad(){
		if(defined('PAGE_LOADING') && PAGE_LOADING == 1 && defined('PAGE_LOAD_TIME')){
			$this->addJSScript(
				'
...
$template = new Bootstrap4_Template($cache, $smarty, $language, $user, $pages);
