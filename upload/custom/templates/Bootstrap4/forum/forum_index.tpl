		    ...
		    {if !empty($forum.subforums)}
			  ...
			  {foreach from=$forum.subforums item=subforum}
			    <div class="row align-items-center">
				  ...
				  <div class="col-md-5">
				    <a {if $subforum->redirect_forum neq 1}href="{$subforum->link}"{else}{if isset($subforum->redirect_confirm)}data-toggle="modal" data-target="#confirmRedirectModal{$subforum->id}" href="#"{else}href="{$subforum->redirect_url}"{/if}{/if}>{$subforum->forum_title}</a><br />
